...
<div class="b-container">
    ...
    <div id="wrap">
        <div class="outer with-side with-transition" style="min-height: 600px;">
            ...
            <div id="admin_right">
                <div class="position"><span>系统</span><span>|</span><span>艺术家</span><span>|</span><span>新增艺术家访谈</span></div>
                <div class="content form_content" style="width:100%">


                    <form action="/cms/artist/interview/add" method="post" id="hfc-form">
                        <#include "interview_form_filed.ftl"/>
                    </form>
                </div>
            </div>
        </div>
...
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/artist/artist_interview_add.js"></script>
