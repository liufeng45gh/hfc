...
<div class="content form_content" >
    <form action="/cms/artist/lecture/update" method="post" id="hfc-form">
        <#include "lecture_form_filed.ftl"/>
    </form>
</div>
...
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/artist/artist_lecture_update.js"></script>
