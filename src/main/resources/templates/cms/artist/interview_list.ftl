                ...
                <div class="content_box" style="border:none">
                    ...
                    <div class="content" style="min-height: 200px;">
                        <table class="list_table" style="font-size:13px;">
                            ...
                            <tbody>
                            <#list interviewList as interview>
                                <tr >
                                    <td class="t_c">${interview.id?default("")}</td>

                                    <td>
                                        <img src="${interview.logo?default("")}" style="width:37px;height:37px;"/>
                                    </td>

                                    <td>${interview.title?default("")}</td>


                                    <td class="t_c">${interview.top?default("")}</td>
                                    <td class="t_c">${interview.clickCount?default("")} </td>

                                    <td objectId="${interview.id?default("")}">
                    ...
                    <input type="hidden" id="update-url" value="/cms/artist/interview/{id}/update"/>
                    <input type="hidden" id="delete-url" value="/cms/artist/interview/{id}/delete"/>
