...
<div class="content form_content" >
    <form action="/cms/artist/interview/update" method="post" id="hfc-form">
...
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/artist/artist_interview_update.js"></script>
