...
<body style="zoom: 1;">
             ...
             <div class="outer with-side with-transition" style="min-height: 600px;">
                    ...
                    <div id="admin_right">
                    			...
                    			<div class="content form_content" style="width:100%">
                                    ...
                                    <form action="/cms/cultural-finance/add" method="post" id="hfc-form">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_cultural_finance_add").addClass("selected");
			 var ue = UE.getEditor('editor');
		});
	</script>
    <script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/cultural-finance/add.js"></script>
