...
<body style="zoom: 1;">
                ...
                <div id="admin_right">
                        ...
                        <div class="content" style="min-height: 200px;">
                            <table class="list_table" style="font-size:13px;">
                                ...
                                <tbody>
                                <#list culturalFinanceCategoryList as category>
                                    <tr>
                    ...
                    <div class="content form_content" >
                        ...
                        <form action="/cms/cultural-finance/category/add" method="post">
                            <table class="table_new" style="width:50%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" id="update-url" value="/cms/cultural-finance/category/{id}/update"/>
                                    </td>
                                </tr>
                            </tbody>
                            </table>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_cultural_finance_category").addClass("selected");


		});
	</script>
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/cultural-finance/category.js"></script>
