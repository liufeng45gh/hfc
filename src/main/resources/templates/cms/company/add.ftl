...
<body style="zoom: 1;">
	<div class="b-container">
        ...
        <div id="wrap">
             <div class="outer with-side with-transition" style="min-height: 600px;">
                    ...
                    <div id="admin_right">
                    			<div class="position"><span>系统</span><span>|</span><span>艺术家</span><span>|</span><span>新增艺术家</span></div>
                    			<div class="content form_content" style="width:100%">


                                    <form action="/cms/company/add" method="post" id="hfc-form">
                                        <#include "company_form_filed.ftl"/>
                                    </form>
                                </div>
                    </div>
             </div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_company_add").addClass("selected");
			 var ue = UE.getEditor('editor');
		});
	</script>
    <script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/company/company_add.js"></script>
