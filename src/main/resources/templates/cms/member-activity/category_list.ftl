...
<body style="zoom: 1;">
                ...
                <div id="admin_right">
                        ...
                        <div class="content" style="min-height: 200px;">
                            <table class="list_table" style="font-size:13px;">
                                ...
                                <tbody>
                                <#list memberActivityCategoryList as category>
                                    <tr>
                    ...
                    <div class="content form_content" >
                        ...
                        <form action="/cms/member-activity/category/add" method="post">
                            <table class="table_new" style="width:50%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" id="update-url" value="/cms/member-activity/category/{id}/update"/>
                                    </td>
                                </tr>
                            </tbody>
                            </table>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_member_activity_category").addClass("selected");
