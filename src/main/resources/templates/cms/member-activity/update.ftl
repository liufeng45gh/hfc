...
<div class="content form_content" >
    <form action="/cms/member-activity/update" method="post" id="hfc-form">
...
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/member-activity/update.js"></script>
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/member-activity/logo_select.js"></script>
