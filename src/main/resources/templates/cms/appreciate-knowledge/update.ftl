...
<div class="position"><span>系统</span><span>|</span><span>鉴赏知识</span><span>|</span><span>修改</span></div>
<div class="content form_content" >
    <form action="/cms/appreciate-knowledge/update" method="post" id="hfc-form">
