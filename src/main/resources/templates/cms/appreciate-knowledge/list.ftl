...
<body style="zoom: 1;">
		...
		<div id="wrap">
            <div class="outer with-side with-transition" style="min-height: 600px;">
                ...
                <div id="admin_right">
                			...
                			<div class="position"><span>内容管理</span><span>&gt;</span><span>鉴赏知识</span><span>&gt;</span><span>列表</span></div>
                			<div class="operating">
                        ...
                        <div class="content" style="min-height: 200px;">
                            <table class="list_table" style="font-size:13px;">
                                ...
                                <tbody>
                                <#list appreciateKnowledgeList as appreciate>
                                    <tr >
                        ...
                        <input type="hidden" id="update-url" value="/cms/appreciate-knowledge/{id}/update"/>
                        <input type="hidden" id="delete-url" value="/cms/appreciate-knowledge/{id}/delete"/>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_appreciate_knowledge_list").addClass("selected");
		});
	</script>
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/appreciate-knowledge/list.js"></script>
