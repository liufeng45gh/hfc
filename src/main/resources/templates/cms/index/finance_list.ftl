        ...
        <div class="outer with-side with-transition" style="min-height: 600px;">
            ...
            <div id="admin_right">
                <div class="content_box" style="border:none">
                    <div class="position"><span>首页管理</span><span>&gt;</span><span>文化金融</span><span>&gt;</span><span>推荐列表</span></div>

                    <div class="content" style="min-height: 200px;">
                        <table class="list_table" style="font-size:13px;">
                            <thead>
                            <tr style="height:30px;">
                                <th width="140px" class="t_c">文化金融id</th>
                    ...
                    <input type="hidden" id="update-url" value="/cms/index/recommend/finance-update"/>
                    <input type="hidden" id="delete-url" value="/cms/index/recommend/{id}/finance-delete"/>
...
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/index/finance_list.js"></script>
