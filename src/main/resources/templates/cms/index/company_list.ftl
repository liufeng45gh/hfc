        ...
        <div class="outer with-side with-transition" style="min-height: 600px;">
            ...
            <div id="admin_right">
                <div class="content_box" style="border:none">
                    <div class="position"><span>首页管理</span><span>&gt;</span><span>海富合作</span><span>&gt;</span><span>推荐列表</span></div>

                    <div class="content" style="min-height: 200px;">
                        <table class="list_table" style="font-size:13px;">
                            <thead>
                            <tr style="height:30px;">
                                <th width="140px" class="t_c">公司id</th>
                            ...
                            <#list indexRecommendList as recommend>
                                <tr >
                                    ...
                                    <td>
                                        ...
                                        <img src="${recommend.target.logo?default("")}" style="width:80px;height:80px;"/>
                                    </td>
                    ...
                    <input type="hidden" id="update-url" value="/cms/index/recommend/company-update"/>
                    <input type="hidden" id="delete-url" value="/cms/index/recommend/{id}/company-delete"/>
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_company").addClass("selected");
		});
</script>
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/index/company_list.js"></script>
