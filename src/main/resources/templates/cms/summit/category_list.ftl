...
<body style="zoom: 1;">
		...
		<div id="wrap">
            <div class="outer with-side with-transition" style="min-height: 600px;">
                ...
                <div id="admin_right">
                			...
                			<div class="position"><span>内容管理</span><span>&gt;</span><span>峰会</span><span>&gt;</span><span>分类</span></div>
                        ...
                        <div class="content" style="min-height: 200px;">
                            <table class="list_table" style="font-size:13px;">
                                ...
                                <tbody>
                                <#list summitCategoryList as category>
                                    <tr>
                    ...
                    <div class="content form_content" >
                        ...
                        <form action="/cms/summit/category/add" method="post">
                            <table class="table_new" style="width:50%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" id="update-url" value="/cms/summit/category/{id}/update"/>
                                    </td>
                                </tr>
                            </tbody>
                            </table>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_summit_category").addClass("selected");


		});
	</script>
<script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/summit/category.js"></script>
