...
import com.lucifer.service.hfc.AppreciateLikeService;
...
public class WebAppreciateLikeController {
    ...
    @RequestMapping(value="/appreciate/{appreciateId}/like",method= RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value="/appreciate/{appreciateId}/like",method= RequestMethod.GET)
    @ResponseBody
